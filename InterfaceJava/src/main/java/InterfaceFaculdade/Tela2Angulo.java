 ...
 * @author padre
 */
public class Tela2Angulo extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Tela2Angulo.class.getName());

    /**
     * Creates new form Tela2Angulo
     */
    public Tela2Angulo() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Tela2Angulo().setVisible(true));
    }
